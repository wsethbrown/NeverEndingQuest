...
```
{original_prompt[:500]}...
[System prompt truncated for brevity - it instructs the AI to run 5th edition combat with initiative order, proper JSON formatting, status tracking, and action commands for state changes]
```
