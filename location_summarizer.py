...
def main():
    """Main function for testing location summarization"""
    # Test data
    test_messages = [
        {
            'role': 'user',
            'content': 'I want to attack the orc with my sword'
        },
        {
            'role': 'assistant', 
            'content': 'You swing your sword and deal 8 damage. The orc is defeated!'
        },
        {
            'role': 'user',
            'content': 'I search the orc for treasure'
        },
        {
            'role': 'assistant',
            'content': 'You find 15 gold pieces and a silver dagger in the orc\'s pouch.'
        }
    ]
